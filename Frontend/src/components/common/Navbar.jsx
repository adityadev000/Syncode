...
const Navbar = () => {
    return (
        ...
        <div className="flex gap-2">
            <button className="bg-blue-600 hover:bg-blue-700 transition px-4 py-2 rounded text-sm font-medium">
            Start Coding
            </button>
            <button className="bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm font-medium">
            Login
            </button>
        </div>
        </nav>
